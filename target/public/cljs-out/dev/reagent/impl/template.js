...
var G__15641 = o;
goog.object.set(G__15641,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__15643__i < G__15643__a.length) {G__15643__a[G__15643__i] = arguments[G__15643__i + 0]; ++G__15643__i;}
  args = new cljs.core.IndexedSeq(G__15643__a,0,null);
} 
...
var G__15645 = o;
goog.object.set(G__15645,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__15649 = props;
var G__15649__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__15649,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__15649);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__15649__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4160__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__15650 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__15650,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__15650;
}
})(),id_class);
...
var G__15651 = (cljs.core.count.call(null,argv) - first_child);
switch (G__15651) {
case (0):
...
var vec__15653 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__15653,(0),null);
var id = cljs.core.nth.call(null,vec__15653,(1),null);
var className = cljs.core.nth.call(null,vec__15653,(2),null);
...
var temp__5461__auto___15656 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5461__auto___15656 == null)){
} else {
var key_15657 = temp__5461__auto___15656;
(jsprops.key = key_15657);
}
...
var temp__5461__auto___15658 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5461__auto___15658 == null)){
} else {
var key_15659 = temp__5461__auto___15658;
(jsprops.key = key_15659);
}
...
var temp__5461__auto___15660 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5461__auto___15660 == null)){
} else {
var key_15661 = temp__5461__auto___15660;
(jsprops.key = key_15661);
}
...
var temp__5461__auto___15662 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5461__auto___15662 == null)){
} else {
var key_15663 = temp__5461__auto___15662;
(jsprops.key = key_15663);
}
...
var temp__5461__auto___15664 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5461__auto___15664 == null)){
} else {
var key_15665 = temp__5461__auto___15664;
(jsprops.key = key_15665);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__15666_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__15666_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__15667 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__15667,(0),null);
var derefed = cljs.core.nth.call(null,vec__15667,(1),null);
...
break;
default:
var G__15672 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__15673 = compiler;
v = G__15672;
compiler = G__15673;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template15677 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template15677 = (function (opts,id,fn_to_element,meta15678){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template15677.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15679,meta15678__$1){
var self__ = this;
var _15679__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template15677(self__.opts,self__.id,self__.fn_to_element,meta15678__$1));
}));

(reagent.impl.template.t_reagent$impl$template15677.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15679){
var self__ = this;
var _15679__$1 = this;
return self__.meta15678;
}));

(reagent.impl.template.t_reagent$impl$template15677.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template15677.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template15677.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template15677.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template15677.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta15678","meta15678",-133079570,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template15677.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template15677.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template15677");

(reagent.impl.template.t_reagent$impl$template15677.cljs$lang$ctorPrWriter = (function (this__4404__auto__,writer__4405__auto__,opt__4406__auto__){
return cljs.core._write.call(null,writer__4405__auto__,"reagent.impl.template/t_reagent$impl$template15677");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template15677.
 */
reagent.impl.template.__GT_t_reagent$impl$template15677 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template15677(opts__$1,id__$1,fn_to_element__$1,meta15678){
return (new reagent.impl.template.t_reagent$impl$template15677(opts__$1,id__$1,fn_to_element__$1,meta15678));
});

}

return (new reagent.impl.template.t_reagent$impl$template15677(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
