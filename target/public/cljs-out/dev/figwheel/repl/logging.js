...
var c_11802 = (new goog.debug.Console());
var G__11801_11803 = c_11802.getFormatter();
goog.object.set(G__11801_11803,"showAbsoluteTime",false);

goog.object.set(G__11801_11803,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_11802);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__11804_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__11804_SHARP_);
