...
return cljs.core.some.call(null,(function (p1__21880_SHARP_){
return ajax.formats.content_type_matches.call(null,content_type,p1__21880_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__21881){
var map__21882 = p__21881;
var map__21882__$1 = cljs.core.__destructure_map.call(null,map__21882);
var request = map__21882__$1;
var response_format = cljs.core.get.call(null,map__21882__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__21884){
var map__21885 = p__21884;
var map__21885__$1 = cljs.core.__destructure_map.call(null,map__21885);
var request = map__21885__$1;
var response_format = cljs.core.get.call(null,map__21885__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.call(null,(function (p1__21883_SHARP_){
return ajax.formats.get_accept_entries.call(null,request,p1__21883_SHARP_);
}),formats);
});
/**
