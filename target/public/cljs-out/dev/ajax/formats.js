...
return cljs.core.some.call(null,(function (p1__19992_SHARP_){
return ajax.formats.content_type_matches.call(null,content_type,p1__19992_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__19993){
var map__19994 = p__19993;
var map__19994__$1 = cljs.core.__destructure_map.call(null,map__19994);
var request = map__19994__$1;
var response_format = cljs.core.get.call(null,map__19994__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__19996){
var map__19997 = p__19996;
var map__19997__$1 = cljs.core.__destructure_map.call(null,map__19997);
var request = map__19997__$1;
var response_format = cljs.core.get.call(null,map__19997__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.call(null,(function (p1__19995_SHARP_){
return ajax.formats.get_accept_entries.call(null,request,p1__19995_SHARP_);
}),formats);
});
/**
