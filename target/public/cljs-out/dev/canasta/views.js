...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__19560),canasta$views$monatsbilanz_tabelle_$_iter__19557.call(null,cljs.core.chunk_rest.call(null,s__19558__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__19560),null);
}
} else {
var m = cljs.core.first.call(null,s__19558__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"height","height",1025178622),"20px",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"size","size",1098693007),"70px",new cljs.core.Keyword(null,"child","child",623967545),canasta.views.monatsnamen.call(null,(cljs.core.key.call(null,m) - (1)))], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"size","size",1098693007),"70px",new cljs.core.Keyword(null,"child","child",623967545),cljs.core.val.call(null,m)], null)], null)], null),canasta$views$monatsbilanz_tabelle_$_iter__19557.call(null,cljs.core.rest.call(null,s__19558__$2)));
}
} else {
return null;
}
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.input_text,new cljs.core.Keyword(null,"model","model",331153215),cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs.core.get.call(null,canasta.spieler.resultate.call(null,tln),runde))?cljs.core.get.call(null,canasta.spieler.resultate.call(null,tln),runde):"")),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__19562_SHARP_){
var v = parseInt(p1__19562_SHARP_);
...
}),namen)),new cljs.core.Keyword(null,"model","model",331153215),"?",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__19563_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"geber","geber",604746862),namen.indexOf(p1__19563_SHARP_)], null));
})], null)], null)], null);
});
...
var _ = (cljs.core.truth_(canasta.spiel.spiel_beendet_QMARK_.call(null,spiel))?re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"spiel-beendet","spiel-beendet",939572612),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [historie,monatshistorie,monatsbilanz,cljs.core.deref.call(null,re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"monat","monat",-186829909)], null))),cljs.core.deref.call(null,re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"jahr","jahr",1260355162)], null)))], null)], null)):null);
var jahr = cljs_time.core.year.call(null,cljs_time.local.local_now.call(null));
var ___$1 = cljs.core.println.call(null,jahr);
if(cljs.core.truth_(spiel)){
if((jahr > cljs.core.deref.call(null,re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"jahr","jahr",1260355162)], null))))){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.title,new cljs.core.Keyword(null,"label","label",1718410804),["Jahressieg: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.key.call(null,cljs.core.first.call(null,cljs.core.frequencies.call(null,cljs.core.vals.call(null,monatsbilanz)))))].join(''),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"level1","level1",813811133)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.gap,new cljs.core.Keyword(null,"size","size",1098693007),"15px"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),"btn-primary",new cljs.core.Keyword(null,"label","label",1718410804),"Neues Jahr beginnen",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"neues-jahr","neues-jahr",772090049)], null));
})], null)], null)], null);
} else {
