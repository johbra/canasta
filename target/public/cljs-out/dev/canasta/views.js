...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__18074),canasta$views$monatsbilanz_tabelle_$_iter__18071.call(null,cljs.core.chunk_rest.call(null,s__18072__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__18074),null);
}
} else {
var m = cljs.core.first.call(null,s__18072__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"height","height",1025178622),"20px",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"size","size",1098693007),"70px",new cljs.core.Keyword(null,"child","child",623967545),canasta.views.monatsnamen.call(null,(cljs.core.key.call(null,m) - (1)))], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"size","size",1098693007),"70px",new cljs.core.Keyword(null,"child","child",623967545),cljs.core.val.call(null,m)], null)], null)], null),canasta$views$monatsbilanz_tabelle_$_iter__18071.call(null,cljs.core.rest.call(null,s__18072__$2)));
}
} else {
return null;
}
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"width","width",-384071477),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(canasta.views.spielerbreite),"px"].join(''),new cljs.core.Keyword(null,"justify","justify",-722524056),new cljs.core.Keyword(null,"end","end",-268185958),new cljs.core.Keyword(null,"child","child",623967545),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sp.resultat_in_runde(tln,(runde - (1))))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),tln], null));
}),teilnehmer)));
});
canasta.views.zwischensumme = (function canasta$views$zwischensumme(spiel,runde){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"height","height",1025178622),"3px",new cljs.core.Keyword(null,"gap","gap",80255254),"10px",new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"width","width",-384071477),"50px",new cljs.core.Keyword(null,"child","child",623967545),""], null),cljs.core.repeat.call(null,sp.anzahl_teilnehmer(spiel),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [canasta.views.sum_strich], null)))], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"gap","gap",80255254),"10px",new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"width","width",-384071477),"50px",new cljs.core.Keyword(null,"child","child",623967545),""], null),cljs.core.doall.call(null,cljs.core.mapv.call(null,(function (tln){
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"width","width",-384071477),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(canasta.views.spielerbreite),"px"].join(''),new cljs.core.Keyword(null,"justify","justify",-722524056),new cljs.core.Keyword(null,"end","end",-268185958),new cljs.core.Keyword(null,"child","child",623967545),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s.zwischen_summe(s.resultate(tln),runde))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),tln], null));
}),sp.teilnehmer(spiel))))], null)], null);
});
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"gap","gap",80255254),"10px",new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.concat.call(null,canasta.views.ergebnis_fuer.call(null,sp.teilnehmer(spiel),r),canasta.views.korrektur_knopf.call(null,r,sp.runde(spiel)))], null),(((r > (1)))?canasta.views.zwischensumme.call(null,spiel,r):null))], null);
}),cljs.core.range.call(null,(1),(sp.runde(spiel) + (1)))));
});
canasta.views.geber_anzeige = (function canasta$views$geber_anzeige(spiel,namen){
if(cljs.core.not.call(null,sp.spiel_beendet_QMARK_(spiel))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.gap,new cljs.core.Keyword(null,"size","size",1098693007),"50px"], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"gap","gap",80255254),"10px",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"child","child",623967545),namen.call(null,sp.geber(spiel))], null)," muss geben."], null)], null)], null);
} else {
return null;
}
});
...
var runde = sp.runde(spiel);
var alle_teilnehmer = sp.teilnehmer(spiel);
return cljs.core.doall.call(null,cljs.core.mapv.call(null,(function (tln){
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.input_text,new cljs.core.Keyword(null,"model","model",331153215),cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs.core.get.call(null,s.resultate(tln),runde))?cljs.core.get.call(null,s.resultate(tln),runde):"")),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__18076_SHARP_){
var v = parseInt(p1__18076_SHARP_);
var index = alle_teilnehmer.indexOf(tln);
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"resultat","resultat",1627423071),s.neues_resultat(tln,v,runde),index,runde], null));
...
var runde = sp.runde(spiel);
var _ = ((cljs.core.not.call(null,sp.spiel_beendet_QMARK_(spiel)))?re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"speichere-welt","speichere-welt",-66606649)], null)):null);
...
}),namen)),new cljs.core.Keyword(null,"model","model",331153215),"?",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__18077_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"geber","geber",604746862),namen.indexOf(p1__18077_SHARP_)], null));
})], null)], null)], null);
});
