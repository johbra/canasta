...
re_frame.core.reg_sub.call(null,new cljs.core.Keyword(null,"monatshistorie","monatshistorie",-354951214),(function (db){
return new cljs.core.Keyword(null,"monatshistorie","monatshistorie",-354951214).cljs$core$IFn$_invoke$arity$1(db);
}));
re_frame.core.reg_sub.call(null,new cljs.core.Keyword(null,"monatsbilanz","monatsbilanz",-863544633),(function (db){
return new cljs.core.Keyword(null,"monatsbilanz","monatsbilanz",-863544633).cljs$core$IFn$_invoke$arity$1(db);
}));
re_frame.core.reg_sub.call(null,new cljs.core.Keyword(null,"monat","monat",-186829909),(function (db){
return new cljs.core.Keyword(null,"monat","monat",-186829909).cljs$core$IFn$_invoke$arity$1(db);
}));
re_frame.core.reg_sub.call(null,new cljs.core.Keyword(null,"jahr","jahr",1260355162),(function (db){
return new cljs.core.Keyword(null,"jahr","jahr",1260355162).cljs$core$IFn$_invoke$arity$1(db);
}));
re_frame.core.reg_sub.call(null,new cljs.core.Keyword(null,"jahressieg","jahressieg",885034826),(function (db){
return new cljs.core.Keyword(null,"jahressieg","jahressieg",885034826).cljs$core$IFn$_invoke$arity$1(db);
}));
