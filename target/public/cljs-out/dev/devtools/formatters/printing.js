...
var len__4771__auto___27390 = arguments.length;
var i__4772__auto___27391 = (0);
while(true){
if((i__4772__auto___27391 < len__4771__auto___27390)){
args__4777__auto__.push((arguments[i__4772__auto___27391]));

var G__27392 = (i__4772__auto___27391 + (1));
i__4772__auto___27391 = G__27392;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27387){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27388,G__27389,seq27387__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27393_SHARP_){
return (!((cljs.core.meta.call(null,p1__27393_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__27394__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27397){var _e__26619__auto__ = e27397;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e27399){var _e__26619__auto__ = e27399;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27401 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27402 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27402);

try{var map__27403 = opts;
var map__27403__$1 = cljs.core.__destructure_map.call(null,map__27403);
var markup_db = cljs.core.get.call(null,map__27403__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27401);
}});
...
var temp__5455__auto___27407 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___27407)){
var managed_print_level_27408 = temp__5455__auto___27407;
var _STAR_print_level_STAR__orig_val__27405_27409 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27406_27410 = managed_print_level_27408;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27406_27410);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__27404_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__27404_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27405_27409);
}} else {
job_fn.call(null);
}
