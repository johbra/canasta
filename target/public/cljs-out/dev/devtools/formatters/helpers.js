...
var G__16226 = devtools.prefs.pref.call(null,v);
v = G__16226;
continue;
} else {
return v;
...
}catch (e16229){var _e__15288__auto__ = e16229;
return false;
}})();
...
}catch (e16233){var _e__15288__auto__ = e16233;
return false;
}})();
...
}catch (e16235){var _e__15288__auto__ = e16235;
return false;
}}
}
});
...
var vec__16237 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16237,(0),null);
var name = cljs.core.nth.call(null,vec__16237,(1),null);
...
return cljs.core.some.call(null,(function (p1__16240_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16240_SHARP_);
}),template);
});
