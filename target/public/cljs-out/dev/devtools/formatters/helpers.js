...
var G__27361 = devtools.prefs.pref.call(null,v);
v = G__27361;
continue;
} else {
return v;
...
}catch (e27364){var _e__26619__auto__ = e27364;
return false;
}})();
...
}catch (e27368){var _e__26619__auto__ = e27368;
return false;
}})();
...
}catch (e27370){var _e__26619__auto__ = e27370;
return false;
}}
}
});
...
var vec__27372 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27372,(0),null);
var name = cljs.core.nth.call(null,vec__27372,(1),null);
...
return cljs.core.some.call(null,(function (p1__27375_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27375_SHARP_);
}),template);
});
