...
var o16106 = temp__5455__auto__;
var temp__5455__auto____$1 = (o16106["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o16107 = temp__5455__auto____$1;
return (o16107["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15281__auto__ = f;
return (o__15281__auto__["toString"]).call(o__15281__auto__);
} else {
return "";
}
}catch (e16108){var _ = e16108;
return "";
}});
...
try{var o__15281__auto___16110 = t;
(o__15281__auto___16110["cljs$lang$ctorPrWriter"]).call(o__15281__auto___16110,t,writer);
}catch (e16109){var __16111 = e16109;
}
...
var char_code = (function (){var o__15281__auto__ = (new String(char$));
return (o__15281__auto__["charCodeAt"]).call(o__15281__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15281__auto__ = String;
return (o__15281__auto__["fromCharCode"]).call(o__15281__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16112 = num_code;
switch (G__16112) {
case (1):
return (185);
...
var o__15281__auto__ = String;
return (o__15281__auto__["fromCharCode"]).call(o__15281__auto__,superscript_code);
});
/**
...
}catch (e16114){var _e__15288__auto__ = e16114;
return false;
}})())){
...
var vec__16115 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16115,(0),null);
...
var len__4771__auto___16124 = arguments.length;
var i__4772__auto___16125 = (0);
while(true){
if((i__4772__auto___16125 < len__4771__auto___16124)){
args__4777__auto__.push((arguments[i__4772__auto___16125]));

var G__16126 = (i__4772__auto___16125 + (1));
i__4772__auto___16125 = G__16126;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16120){
var vec__16121 = p__16120;
var ns_detector = cljs.core.nth.call(null,vec__16121,(0),null);
...
var G__16127 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16128 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16127;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16118){
var G__16119 = cljs.core.first.call(null,seq16118);
var seq16118__$1 = cljs.core.next.call(null,seq16118);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16119,seq16118__$1);
}));
...
var vec__16132 = cljs.core.split_with.call(null,(function (p1__16131_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16131_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16132,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16132,(1),null);
...
var vec__16138 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16138,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16138,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16141 = cljs.core.rest.call(null,remaining_tokens);
var G__16142 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16141;
name_tokens = G__16142;
continue;
} else {
...
var vec__16145 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16145,(0),null);
var arity = cljs.core.nth.call(null,vec__16145,(1),null);
var vec__16148 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16148,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16148,(1),null);
var vec__16151 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16151,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16151,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16151,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16151,(3),null);
...
var vec__16157 = result;
var munged_ns = cljs.core.nth.call(null,vec__16157,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16157,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16157,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16157,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16157,(4),null);
var arity = cljs.core.nth.call(null,vec__16157,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__16161 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__16161,(0),null);
var args = cljs.core.nth.call(null,vec__16161,(1),null);
var vec__16164 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16164,(0),null);
var name = cljs.core.nth.call(null,vec__16164,(1),null);
...
var G__16167 = (arity + (1));
var G__16168 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16169){
var vec__16170 = p__16169;
var arity = cljs.core.nth.call(null,vec__16170,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16170,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__16173_SHARP_){
return cljs.core.get.call(null,arities,p1__16173_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__16174_SHARP_){
return cljs.core.drop.call(null,(2),p1__16174_SHARP_);
}),sorted_infos);
...
var args__4777__auto__ = [];
var len__4771__auto___16181 = arguments.length;
var i__4772__auto___16182 = (0);
while(true){
if((i__4772__auto___16182 < len__4771__auto___16181)){
args__4777__auto__.push((arguments[i__4772__auto___16182]));

var G__16183 = (i__4772__auto___16182 + (1));
i__4772__auto___16182 = G__16183;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16177){
var vec__16178 = p__16177;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16178,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16175){
var G__16176 = cljs.core.first.call(null,seq16175);
var seq16175__$1 = cljs.core.next.call(null,seq16175);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16176,seq16175__$1);
}));
...
var map__16186 = options;
var map__16186__$1 = cljs.core.__destructure_map.call(null,map__16186);
var include_ns_QMARK_ = cljs.core.get.call(null,map__16186__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16186__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16186__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16186__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16187 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16187,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16187,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16187,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16187,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16187,(4),null);
var arity = cljs.core.nth.call(null,vec__16187,(5),null);
...
var o__15281__auto__ = f;
return (o__15281__auto__["getBasis"]).call(o__15281__auto__);
});
/**
...
}catch (e16190){var _e__15288__auto__ = e16190;
...
var G__16191 = (obj[cljs.core.first.call(null,path)]);
var G__16192 = cljs.core.rest.call(null,path);
obj = G__16191;
path = G__16192;
continue;
} else {
...
var _STAR_ = (function (accum,p__16193){
var vec__16194 = p__16193;
var bit = cljs.core.nth.call(null,vec__16194,(0),null);
var protocol = cljs.core.nth.call(null,vec__16194,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16197){
var vec__16198 = p__16197;
var ns = cljs.core.nth.call(null,vec__16198,(0),null);
var name = cljs.core.nth.call(null,vec__16198,(1),null);
var selector = cljs.core.nth.call(null,vec__16198,(2),null);
...
var post_process = (function (p__16202){
var vec__16203 = p__16202;
var munged_name = cljs.core.nth.call(null,vec__16203,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16203,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__16201_SHARP_){
return (obj[cljs.core.first.call(null,p1__16201_SHARP_)]);
}),sorted_matches);
