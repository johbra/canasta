...
var o11223 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11223["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11224 = temp__5455__auto____$1;
return (o11224["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10978__auto__ = f;
return (o__10978__auto__["toString"]).call(o__10978__auto__);
} else {
return "";
}
}catch (e11225){var _ = e11225;
return "";
}});
...
try{var o__10978__auto___11227 = t;
(o__10978__auto___11227["cljs$lang$ctorPrWriter"]).call(o__10978__auto___11227,t,writer);
}catch (e11226){var __11228 = e11226;
}
...
var char_code = (function (){var o__10978__auto__ = (new String(char$));
return (o__10978__auto__["charCodeAt"]).call(o__10978__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10978__auto__ = String;
return (o__10978__auto__["fromCharCode"]).call(o__10978__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11229 = num_code;
switch (G__11229) {
case (1):
return (185);
...
var o__10978__auto__ = String;
return (o__10978__auto__["fromCharCode"]).call(o__10978__auto__,superscript_code);
});
/**
...
}catch (e11231){var _e__10985__auto__ = e11231;
return false;
}})())){
...
var vec__11232 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11232,(0),null);
...
var or__4160__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
var temp__5459__auto__ = goog.object.getValueByKeys(devtools.munging.get_global_scope.call(null),ns_module_name.split("."));
if((temp__5459__auto__ == null)){
return null;
} else {
var ns_obj = temp__5459__auto__;
...
var len__4771__auto___11241 = arguments.length;
var i__4772__auto___11242 = (0);
while(true){
if((i__4772__auto___11242 < len__4771__auto___11241)){
args__4777__auto__.push((arguments[i__4772__auto___11242]));

var G__11243 = (i__4772__auto___11242 + (1));
i__4772__auto___11242 = G__11243;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11237){
var vec__11238 = p__11237;
var ns_detector = cljs.core.nth.call(null,vec__11238,(0),null);
...
var G__11244 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11245 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11244;
remaining_tokens = G__11245;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11235){
var G__11236 = cljs.core.first.call(null,seq11235);
var seq11235__$1 = cljs.core.next.call(null,seq11235);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11236,seq11235__$1);
}));
...
var vec__11249 = cljs.core.split_with.call(null,(function (p1__11248_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11248_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11249,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11249,(1),null);
...
var vec__11255 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11255,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11255,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11258 = cljs.core.rest.call(null,remaining_tokens);
var G__11259 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11258;
name_tokens = G__11259;
continue;
} else {
...
var vec__11262 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11262,(0),null);
var arity = cljs.core.nth.call(null,vec__11262,(1),null);
var vec__11265 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11265,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11265,(1),null);
var vec__11268 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11268,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11268,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11268,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11268,(3),null);
...
var vec__11274 = result;
var munged_ns = cljs.core.nth.call(null,vec__11274,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11274,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11274,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11274,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11274,(4),null);
var arity = cljs.core.nth.call(null,vec__11274,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__11278 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__11278,(0),null);
var args = cljs.core.nth.call(null,vec__11278,(1),null);
var vec__11281 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__11281,(0),null);
var name = cljs.core.nth.call(null,vec__11281,(1),null);
...
var G__11284 = (arity + (1));
var G__11285 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11286){
var vec__11287 = p__11286;
var arity = cljs.core.nth.call(null,vec__11287,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11287,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__11290_SHARP_){
return cljs.core.get.call(null,arities,p1__11290_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__11291_SHARP_){
return cljs.core.drop.call(null,(2),p1__11291_SHARP_);
}),sorted_infos);
...
var args__4777__auto__ = [];
var len__4771__auto___11298 = arguments.length;
var i__4772__auto___11299 = (0);
while(true){
if((i__4772__auto___11299 < len__4771__auto___11298)){
args__4777__auto__.push((arguments[i__4772__auto___11299]));

var G__11300 = (i__4772__auto___11299 + (1));
i__4772__auto___11299 = G__11300;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11294){
var vec__11295 = p__11294;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11295,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11292){
var G__11293 = cljs.core.first.call(null,seq11292);
var seq11292__$1 = cljs.core.next.call(null,seq11292);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11293,seq11292__$1);
}));
...
var G__11301 = arg;
var G__11301__$1 = (((G__11301 instanceof cljs.core.Keyword))?G__11301.fqn:null);
switch (G__11301__$1) {
...
var map__11303 = options;
var map__11303__$1 = cljs.core.__destructure_map.call(null,map__11303);
var include_ns_QMARK_ = cljs.core.get.call(null,map__11303__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11303__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11303__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11303__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11304 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11304,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11304,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11304,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11304,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11304,(4),null);
var arity = cljs.core.nth.call(null,vec__11304,(5),null);
...
var o__10978__auto__ = f;
return (o__10978__auto__["getBasis"]).call(o__10978__auto__);
});
/**
...
}catch (e11307){var _e__10985__auto__ = e11307;
...
var G__11308 = (obj[cljs.core.first.call(null,path)]);
var G__11309 = cljs.core.rest.call(null,path);
obj = G__11308;
path = G__11309;
continue;
} else {
...
var _STAR_ = (function (accum,p__11310){
var vec__11311 = p__11310;
var bit = cljs.core.nth.call(null,vec__11311,(0),null);
var protocol = cljs.core.nth.call(null,vec__11311,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11314){
var vec__11315 = p__11314;
var ns = cljs.core.nth.call(null,vec__11315,(0),null);
var name = cljs.core.nth.call(null,vec__11315,(1),null);
var selector = cljs.core.nth.call(null,vec__11315,(2),null);
...
var post_process = (function (p__11319){
var vec__11320 = p__11319;
var munged_name = cljs.core.nth.call(null,vec__11320,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11320,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__11318_SHARP_){
return (obj[cljs.core.first.call(null,p1__11318_SHARP_)]);
}),sorted_matches);
