...
}catch (e12426){var _e = e12426;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___12428 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___12428)){
var seen_errors_12429 = temp__5455__auto___12428;
if(cljs.core.truth_(seen_errors_12429.has(self))){
} else {
seen_errors_12429.add(self);

var temp__5457__auto___12430 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___12430)){
var sense_12431 = temp__5457__auto___12430;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12431)].join(''));
} else {
}
}
} else {
