...
}catch (e29721){var _e = e29721;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___29723 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___29723)){
var seen_errors_29724 = temp__5455__auto___29723;
if(cljs.core.truth_(seen_errors_29724.has(self))){
} else {
seen_errors_29724.add(self);

var temp__5457__auto___29725 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___29725)){
var sense_29726 = temp__5457__auto___29725;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29726)].join(''));
} else {
}
}
} else {
