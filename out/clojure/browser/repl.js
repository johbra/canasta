...
var seq__2030_2034 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__2031_2035 = null;
var count__2032_2036 = (0);
var i__2033_2037 = (0);
while(true){
if((i__2033_2037 < count__2032_2036)){
var str_2038 = cljs.core._nth.call(null,chunk__2031_2035,i__2033_2037);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_2038})));


var G__2039 = seq__2030_2034;
var G__2040 = chunk__2031_2035;
var G__2041 = count__2032_2036;
var G__2042 = (i__2033_2037 + (1));
seq__2030_2034 = G__2039;
chunk__2031_2035 = G__2040;
count__2032_2036 = G__2041;
i__2033_2037 = G__2042;
continue;
} else {
var temp__5754__auto___2043 = cljs.core.seq.call(null,seq__2030_2034);
if(temp__5754__auto___2043){
var seq__2030_2044__$1 = temp__5754__auto___2043;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__2030_2044__$1)){
var c__4591__auto___2045 = cljs.core.chunk_first.call(null,seq__2030_2044__$1);
var G__2046 = cljs.core.chunk_rest.call(null,seq__2030_2044__$1);
var G__2047 = c__4591__auto___2045;
var G__2048 = cljs.core.count.call(null,c__4591__auto___2045);
var G__2049 = (0);
seq__2030_2034 = G__2046;
chunk__2031_2035 = G__2047;
count__2032_2036 = G__2048;
i__2033_2037 = G__2049;
continue;
} else {
var str_2050 = cljs.core.first.call(null,seq__2030_2044__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_2050})));


var G__2051 = cljs.core.next.call(null,seq__2030_2044__$1);
var G__2052 = null;
var G__2053 = (0);
var G__2054 = (0);
seq__2030_2034 = G__2051;
chunk__2031_2035 = G__2052;
count__2032_2036 = G__2053;
i__2033_2037 = G__2054;
continue;
}
} else {
}
...
var onload = (function (){
if(cljs.core.truth_((function (){var and__4149__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__2059 = script;
goog.object.set(G__2059,"type","text/javascript");

goog.object.set(G__2059,"onload",onload);

goog.object.set(G__2059,"onreadystatechange",onload);

return G__2059;
})();
if((opt_sourceText == null)){
var G__2060 = script__$1;
goog.object.set(G__2060,"src",src);

return G__2060;
} else {
var G__2061 = script__$1;
goog.dom.setTextContent(G__2061,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__4160__auto__ = reload;
...
var path_2062 = goog.debugLoader_.getPathFromDeps_(src);
goog.object.remove(goog.debugLoader_.written_,path_2062);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_2062)].join(''));
} else {
var path_2063 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_2063);

goog.object.remove(goog.dependencies_.written,path_2063);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_2063)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__2064 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__2065 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__2065);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__2064);
}})()})));
}));
